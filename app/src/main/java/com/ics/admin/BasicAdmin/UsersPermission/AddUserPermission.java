package com.ics.admin.BasicAdmin.UsersPermission;
...
public class AddUserPermission extends AppCompatActivity {
...
//                dialog.dismiss();
                ...
                try {
                    ...
                    if(!jsonObject1.getBoolean("responce")){
                        Toast.makeText(AddUserPermission.this, "Nothing found", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getApplication(),"strong OTP"+result, Toast.LENGTH_SHORT).show();
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(AddUserPermission.this);
                        recyclerView.setLayoutManager(linearLayoutManager); // set LayoutManager to RecyclerView

                        FacultyAdapter facultyAdapter = new FacultyAdapter(AddUserPermission.this,facultiesArrayList);
