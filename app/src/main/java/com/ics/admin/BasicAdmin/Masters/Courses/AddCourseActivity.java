...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class_spiner =  findViewById(R.id.class_spiner_course);
        //+++++++++++++++++++++++++++++++++Call For get class+++++++++++++++++++++++++++
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!edt_name.getText().toString().isEmpty()){
                    new ADDCOURSE(edt_name.getText().toString() ,sel_id).execute();
                }
                // new AddStudentActivity.AddBatch(Shared_Preference.getId(ViewCourseActivity.this),sel_id,edt_name.getText().toString()).execute();
            }
        });
    }
    private class ADDCOURSE extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            adminProgressdialog= new AdminProgressdialog(AddCourseActivity.this);
            super.onPreExecute();
        }
